...
// NewGQueue ...
func NewGQueue(topicID, subscriptionID, projectID, credential string) *GQueue {
...
// GQueue implementations of Stream using google pub/sub
type GQueue struct {
	topic        *pubsub.Topic
...
func (s *GQueue) Push(data interface{}) error {
...
func (s *GQueue) Pull() (interface{}, error) {
	s.once.Do(func() {
		go s.receive()
	})
